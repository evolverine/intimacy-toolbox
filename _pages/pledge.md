...
(<span class="small mark">What's the story with this pledge? Read about it [here]({{ site.baseurl }}{% link _pages/about.md %}).</span> And for the text that's hard to read, just click on it and it will magically reveal itself!)
